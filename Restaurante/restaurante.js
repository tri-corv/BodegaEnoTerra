...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Botones (si están en tu HTML)
    const btnEnoturismo = document.getElementById('btn-enoturismo');
    const btnVinos = document.getElementById('btn-vinos');
    const btnExperiencias = document.getElementById('btn-experiencias');
  
    if (btnEnoturismo) btnEnoturismo.onclick = () => window.location.href = '../Enoturismo/enoturismo.html';
    if (btnVinos) btnVinos.onclick = () => window.location.href = '../Vinos/vinos.html';
    if (btnExperiencias) btnExperiencias.onclick = () => window.location.href = '../Restaurante/restaurante.html';
  });
